...
import { VariableSchema, VariableSchemaTypeName } from '@shukun/schema';
...
export type SchemaRecursiveEditorProps = {
...
export const SchemaRecursiveEditor = ({
  value,
  onChange,
  ...
  return (
    <Box>
      <Group mb="md">
        <FieldNameInput
          value={fieldName}
          disabled={fieldLevel === 0 || isItemField}
