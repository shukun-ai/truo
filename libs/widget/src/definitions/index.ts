...
import checkboxSelectDefinitionJson from './checkbox-select.definition.json';
...
export const checkboxSelectDefinition =
  checkboxSelectDefinitionJson as any as WidgetSchema;
